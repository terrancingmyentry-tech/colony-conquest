...
// Insert the module-level function before the '// -------------------------\n// AI behavior' section
const moduleFunc = `
// -------------------------
...
// Simply insert before the AI behavior section
const markerLine = '\n// -------------------------\n// AI behavior\nfunction runAI';
const replacement = moduleFunc + '// -------------------------\n// AI behavior\nfunction runAI';

if (!content.includes(moduleFunc)) {
  content = content.replace(markerLine, replacement);
  fs.writeFileSync(filePath, content, 'utf8');
  console.log('Module-level function added successfully!');
} else {
  console.log('Function already exists at module level');
}
